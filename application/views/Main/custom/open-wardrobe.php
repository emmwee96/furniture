                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="compare-content-wrap">
                                ...
                                <div class="skill-checklist">
                                    ...
                                    <select id="skillc" name="internalFrame">
                                        <option value="">-- select a type --</option>
                                ...
                                <div class="compare-conpart skill-communicate">
                                    <div class="skill-checklist">
                                        ...
                                        <select id="skillc" name="externalFrame">
                                            <option value="">-- select a type --</option>
                                ...
                                <div class="compare-conpart skill-communicate">
                                    <div class="skill-checklist">
                                        ...
                                        <input type="checkbox"  name="drawer"> Drawer<br>
                                        <input type="checkbox" name="shelving"> Shelving<br>
                                    </div>
