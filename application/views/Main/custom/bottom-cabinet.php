	...
	<div class="container">
		<div class="row">
				...
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="compare-content-wrap">
						<div class="cmain-heading text-uppercase">
							<h3 class="product_title">Bottom Cabinet</h3>
						</div>
						...
						<div class="compare-conpart-pm compare-bottom" style="border:none;padding-bottom:0;display:none;">
			...
			<div class="col-md-2 col-lg-2">
				<?php $this->load->view("Main/custom/my_selection",array("selection_labels" => $selection_labels, "add_ons" => $add_ons, "width_label" => "Install Width (mm)")); ?>
			</div>
		</div>
