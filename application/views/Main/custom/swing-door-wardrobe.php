                            ...
                            <div  class="product_extra_images">
                                <div class="row">
                                    <div class="col-md-4 col-lg-4">
                                            <a class="gallery" data-fancybox="gallery" href="<?= site_url(); ?>/images/product/custom/swing1.jpg">
                                            <img src="<?= site_url(); ?>/images/product/custom/swing1.jpg">
                                        </a>
                                    </div>
                                    <div class="col-md-4 col-lg-4">
                                            <a class="gallery" data-fancybox="gallery" href="<?= site_url(); ?>/images/product/custom/swing2.jpg">
                                            <img src="<?= site_url(); ?>/images/product/custom/swing2.jpg">
                                        </a>
                                    </div>
                                    <div class="col-md-4 col-lg-4">
                                            <a class="gallery" data-fancybox="gallery" href="<?= site_url(); ?>/images/product/custom/swing3.jpg">
                                            <img src="<?= site_url(); ?>/images/product/custom/swing3.jpg">
                                        </a>
                                    </div>
                                    <div class="col-md-4 col-lg-4">
                                            <a class="gallery" data-fancybox="gallery" href="<?= site_url(); ?>/images/product/custom/swing4.jpg">
                                            <img src="<?= site_url(); ?>/images/product/custom/swing4.jpg">
                                        </a>
                                    </div>
                                    <div class="col-md-4 col-lg-4">
                                            <a class="gallery" data-fancybox="gallery" href="<?= site_url(); ?>/images/product/custom/swing5.jpg">
                                            <img src="<?= site_url(); ?>/images/product/custom/swing5.jpg">
                                        </a>
                                    </div>
                                </div>
                            </div>
