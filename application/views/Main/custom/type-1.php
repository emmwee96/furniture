					...
					<div class="single-cat-main">
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active single-carousel" id="tab-1">
								...
								<div class="tab-single-image">
									<a href="<?= site_url() . $product['banner'] ?>" class="fancybox" data-fancybox-group="gallery">
										<img data-img="<?= site_url() . $product['banner']; ?>" src="<?= site_url() . $product['banner']; ?>">
									</a>
								</div>
							...
							<?php
								if(count($product_image) == 1 - 1){
									?>
									style="margin-left:-52%;"
									<?php
								} else if(count($product_image) == 2 - 1){
									?>
									style="margin-left:-30%;"
									<?php
								} else if(count($product_image) == 3 - 1){
									?>
							...
							?>>
								<div>
									<a class="gallery">
										<img class="sub_image" data-img="<?= site_url() . $product['banner']; ?>" src="<?= site_url() . $product['banner']; ?>">
									</a>
								</div>
								<?php foreach ($product_image as $row) { ?>
								<div>
				...
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="compare-content-wrap">
						<div class="cmain-heading text-uppercase">
							<h3 class="product_title">Type 1</h3>
						</div>
