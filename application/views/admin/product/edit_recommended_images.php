                    ...
                    <div class="box-body">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs" id="tabs">
                                <li class="active">
                                    <a href="#add" data-toggle="tab">Add New Image</a>
                                </li>
                                <li>
                                        ...
                                        <?php foreach ($images as $row) {
                                            ...
                                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 product-image-container">
                                                ...
                                                <div class="delete-product-image-container">
                                                    <button class="btn btn-danger delete-image-button" data-id="<?= $row['custom_product_image_id'] ?>"><i class="fa fa-close"></i></button>
                                                </div>
                                            </div>
                                        <?php }
                                        ?>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    setTimeout(function () {
                        window.location = "<?= site_url('Product/details/' . $custom_product_id); ?>";
                    }, 1500);
                } else {
                    $("#loader-wrapper").addClass("hidden");
